...
imparteRoutes.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    imparteControllers.getAll((err, results) => {
        if (err) {
            return res.status(500).json({ 'message': err.message });
        }
...
imparteRoutes.delete('/:id_p', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
